...
const portal = fs.readFileSync("attached_assets/worlds/haunted_woods/soul-exchange-portal-v3.svg", "utf8");
...
test("Haunted Woods Soul Exchange marker is a prominent animated soul flame", () => {
  assert.match(portal, /class="se-flame"/);
  assert.match(portal, /class="se-ring"/);
  assert.match(portal, /class="se-mote/);
