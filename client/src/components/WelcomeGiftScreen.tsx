...
export default function WelcomeGiftScreen({ user, onComplete }: WelcomeGiftScreenProps) {
  ...
  const [phase, setPhase] = useState<"reveal" | "collect" | "claiming" | "done">("reveal");
  ...
  useEffect(() => {
    const timer = setTimeout(() => setPhase("collect"), 1800);
        ...
        <div className="px-6 pt-6 pb-7">
          ...
          {welcomeReward ? (
            ...
            <div className="mb-5 text-center py-3">
              <p style={{ color: "rgba(200,185,155,0.6)", fontSize: 12, fontStyle: "italic" }}>Loading your gifts…</p>
            </div>
          )}
