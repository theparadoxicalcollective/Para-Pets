...
export default function EvolutionPanel({ enabled, fallbackRarity }: EvolutionPanelProps) {
  ...
  return <div className="pup-evolution-skin" style={style}>
    <style>{`
      ...
      .pup-evolution-skin .pupevo-slot:nth-of-type(1){left:24% !important;top:61% !important}
      .pup-evolution-skin .pupevo-slot:nth-of-type(2){left:12% !important;top:43% !important}
      .pup-evolution-skin .pupevo-slot:nth-of-type(3){left:29% !important;top:22% !important}
      .pup-evolution-skin .pupevo-slot:nth-of-type(4){left:71% !important;top:22% !important}
      .pup-evolution-skin .pupevo-slot:nth-of-type(5){left:88% !important;top:43% !important}
      .pup-evolution-skin .pupevo-slot:nth-of-type(6){left:76% !important;top:61% !important}
