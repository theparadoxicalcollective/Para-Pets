...
export default function EvolutionPanel({ enabled, fallbackRarity }: EvolutionPanelProps) {
  ...
  return <div className="pup-evolution-skin" style={style}>
    <style>{`
      ...
      .pup-evolution-skin .pupevo-slot { width:clamp(66px,18vw,96px) !important; height:clamp(66px,18vw,96px) !important; }
      .pup-evolution-skin .pupevo-slot:nth-of-type(1){left:29% !important;top:29% !important}
      .pup-evolution-skin .pupevo-slot:nth-of-type(2){left:71% !important;top:29% !important}
      .pup-evolution-skin .pupevo-slot:nth-of-type(3){left:13% !important;top:49% !important}
      .pup-evolution-skin .pupevo-slot:nth-of-type(4){left:87% !important;top:49% !important}
      .pup-evolution-skin .pupevo-slot:nth-of-type(5){left:23% !important;top:70% !important}
      ...
      .pup-evolution-skin .pupevo-slot.current { pointer-events:auto; }
