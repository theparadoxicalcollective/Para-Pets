...
@media(max-width:430px){.pupage-head{min-height:96px;padding-left:55px;padding-right:55px}.pupage-logo{width:82vw}.pupage-corner{width:52px;height:52px}.pupage-capacity{padding:10px 12px;margin-top:0}.pupage-enhance{width:94%}.pupage-stage{height:clamp(405px,116vw,500px)}.pupage-pet-zone{width:min(66vw,270px);height:min(66vw,270px);top:46%}.pupage-platform{width:82%;top:55%}.pupage-nameplate{width:98%}.pupage-stat-row{left:22%;right:6%;grid-template-columns:minmax(0,1fr) 43px 34px;gap:5px}.pupage-items-window{left:13%;right:13%}.pupage-arrow{width:34px;height:43px}}
`;
