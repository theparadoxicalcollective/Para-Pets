...
.pupage{position:fixed;inset:0;width:100%;max-width:768px;margin:0 auto;overflow:hidden;background:#020a0c;color:#effff6;isolation:isolate;font-family:Georgia,serif;touch-action:pan-y}.pupage *{box-sizing:border-box}.pupage-bg{position:absolute;inset:0;width:100%;height:100%;object-fit:cover;object-position:center top;z-index:-3;pointer-events:none}.pupage-vignette{position:absolute;inset:0;z-index:-2;pointer-events:none;background:linear-gradient(180deg,rgba(0,6,9,.08),rgba(0,7,9,.03) 62%,rgba(0,4,7,.58))}.pupage-scroll{height:100%;width:100%;overflow-y:auto;overflow-x:hidden;overscroll-behavior-y:contain;overscroll-behavior-x:none;-webkit-overflow-scrolling:touch;scrollbar-width:none;padding:max(env(safe-area-inset-top),8px) 10px max(env(safe-area-inset-bottom),20px)}.pupage-scroll::-webkit-scrollbar{display:none}.pupage-head{position:relative;min-height:148px;padding:4px 62px 0;text-align:center}.pupage-logo{display:block;width:min(78vw,500px);max-width:100%;height:auto;margin:4px auto 2px;object-fit:contain;filter:drop-shadow(0 0 9px rgba(76,255,170,.3))}.pupage-sub{max-width:430px;margin:0 auto;color:#edf6df;font-size:clamp(14px,3.8vw,20px);line-height:1.25;text-shadow:0 2px 4px #00120e}.pupage-corner{position:absolute;top:0;width:58px;height:58px;border:0;padding:0;background:transparent;z-index:15;cursor:pointer;-webkit-tap-highlight-color:transparent}.pupage-corner img{display:block;width:100%;height:100%;object-fit:contain;filter:drop-shadow(0 4px 8px #0009)}.pupage-bag{left:0}.pupage-close{right:0}.pupage-corner:active{transform:scale(.96)}
.pupage-enhance{position:relative;width:min(88%,520px);margin:2px auto 0;display:grid;place-items:center}.pupage-enhance-art{display:block;width:100%;height:auto;pointer-events:none}.pupage-enhance-copy{position:absolute;inset:0;display:grid;place-items:center;padding:0 16%;color:#ecffe9;font-size:clamp(14px,4vw,22px);font-weight:700;white-space:nowrap;text-shadow:0 2px 5px #00130d}
.pupage-stage{position:relative;width:100%;max-width:610px;height:clamp(420px,112vw,570px);margin:-2px auto 0}.pupage-platform{position:absolute;left:50%;top:55%;width:min(78%,455px);height:auto;transform:translate(-50%,-50%);z-index:2;pointer-events:none;filter:drop-shadow(0 10px 14px #0007)}.pupage-pet-zone{position:absolute;left:50%;top:44%;width:min(64vw,350px);height:min(64vw,350px);transform:translate(-50%,-50%);display:grid;place-items:center;z-index:6;touch-action:pan-y;transition:filter .18s,transform .18s}.pupage-pet-zone.over{filter:drop-shadow(0 0 22px #4cffae);transform:translate(-50%,-50%) scale(1.035)}.pupage-pet{width:100%;height:100%;display:grid;place-items:center;pointer-events:none;filter:drop-shadow(0 11px 10px #0008)}.pupage-pet>img{display:block;width:100%;height:100%;object-fit:contain}.pupage-placeholder{width:72%!important;height:72%!important;opacity:.72}.pupage-pet.bounce{animation:pupageBounce .72s ease-out}.pupage-pet.flash{animation:pupageFlash .58s ease-out}.pupage-nameplate{position:absolute;left:50%;bottom:0;width:min(94%,540px);transform:translateX(-50%);z-index:12}.pupage-nameplate-art{display:block;width:100%;height:auto;pointer-events:none}.pupage-name{position:absolute;left:15%;right:31%;top:50%;transform:translateY(-52%);overflow:hidden;text-overflow:ellipsis;white-space:nowrap;text-align:center;color:#f7dd98;font-size:clamp(18px,5vw,29px);text-shadow:0 2px 4px #000}.pupage-level{position:absolute;right:8.5%;top:50%;transform:translateY(-50%);color:#c6ffe1;font:700 clamp(12px,3.7vw,18px)/1 system-ui,sans-serif;white-space:nowrap;text-shadow:0 2px 3px #00130d}
.pupage-capacity{width:100%;max-width:560px;margin:10px auto 10px;padding:11px 16px 10px;border:1px solid rgba(69,219,142,.72);border-radius:18px;background:linear-gradient(180deg,rgba(4,31,24,.95),rgba(2,15,13,.96));box-shadow:inset 0 0 22px rgba(42,215,128,.11),0 7px 20px #0007}.pupage-cap-head{display:flex;justify-content:space-between;align-items:center;gap:9px;margin-bottom:7px;color:#deffec;font:800 11px/1.2 system-ui,sans-serif;letter-spacing:.09em}.pupage-cap-head span:last-child{color:#94f6be;letter-spacing:.01em;text-align:right}.pupage-cap-track{height:10px;border:1px solid #4b7463;border-radius:999px;background:#020d0a;overflow:hidden}.pupage-cap-track i{display:block;height:100%;border-radius:inherit;background:linear-gradient(90deg,#168254,#42e494,#a1ffd1);box-shadow:0 0 10px rgba(77,255,174,.42);transition:width .28s ease}.pupage-cap-ticks{display:flex;justify-content:space-between;gap:8px;margin-top:5px;color:#8caf9e;font:600 9px/1.2 system-ui,sans-serif}.pupage-cap-ticks span:last-child{text-align:right}
.pupage-stats{position:relative;width:100%;max-width:570px;margin:3px auto 12px}.pupage-stat-art{display:block;width:100%;height:auto;pointer-events:none;filter:drop-shadow(0 8px 20px #0007)}.pupage-stat-row{position:absolute;left:22%;right:7%;height:18%;display:grid;grid-template-columns:minmax(0,1fr) 53px 38px;align-items:center;gap:7px}.pupage-stat-row.atk{top:18%}.pupage-stat-row.def{top:42%}.pupage-stat-row.hp{top:66%}.pupage-stat-track{height:12px;border-radius:999px;background:rgba(2,15,12,.72);overflow:hidden}.pupage-stat-fill{height:100%;border-radius:inherit;box-shadow:0 0 8px currentColor}.atk .pupage-stat-fill{background:linear-gradient(90deg,#d44a56,#ff737b);color:#ff737b}.def .pupage-stat-fill{background:linear-gradient(90deg,#3776d4,#69a5ff);color:#69a5ff}.hp .pupage-stat-fill{background:linear-gradient(90deg,#24a25e,#52ec8b);color:#52ec8b}.pupage-stat-value{text-align:right;font-size:clamp(15px,4.3vw,21px);text-shadow:0 2px 3px #000}.atk .pupage-stat-value{color:#ff8188}.def .pupage-stat-value{color:#7db2ff}.hp .pupage-stat-value{color:#67ef98}.pupage-stat-plus{width:100%;height:100%;border:0;border-radius:50%;background:transparent;color:transparent;cursor:pointer;-webkit-tap-highlight-color:transparent}.pupage-stat-plus:focus-visible{outline:2px solid #ffe177;outline-offset:-3px}.pupage-sr{position:absolute!important;width:1px!important;height:1px!important;padding:0!important;margin:-1px!important;overflow:hidden!important;clip:rect(0,0,0,0)!important;white-space:nowrap!important;border:0!important}
.pupage-inventory{position:relative;width:100%;max-width:590px;margin:4px auto 0}.pupage-inventory-art{display:block;width:100%;height:auto;pointer-events:none;filter:drop-shadow(0 10px 18px #0008)}.pupage-items-window{position:absolute;left:13%;right:13%;top:20%;height:53%;display:grid;grid-template-columns:repeat(5,minmax(0,1fr));align-items:stretch}.pupage-item{position:relative;min-width:0;border:0;background:transparent;padding:6%;display:grid;place-items:center;touch-action:none;user-select:none;-webkit-tap-highlight-color:transparent}.pupage-item.disabled{opacity:.42;filter:grayscale(.8)}.pupage-item img{display:block;width:82%;height:82%;object-fit:contain;pointer-events:none;filter:drop-shadow(0 3px 4px #0008)}.pupage-item-caption{position:absolute;left:3%;right:3%;top:1%;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;text-align:center;color:#d7f7e5;font:600 8px/1 system-ui,sans-serif;text-shadow:0 1px 2px #000}.pupage-qty{position:absolute;right:7%;bottom:4%;min-width:22px;height:22px;padding:0 5px;display:grid;place-items:center;border-radius:999px;border:1px solid #cfab54;background:#07110ee8;color:white;font:700 11px/1 system-ui,sans-serif}.pupage-empty{position:absolute;left:14%;right:14%;top:37%;text-align:center;color:#edf7ef;font-size:clamp(13px,3.7vw,19px);text-shadow:0 2px 4px #000}.pupage-arrow{position:absolute;top:39%;transform:translateY(-50%);z-index:6;width:38px;height:48px;border:0;background:rgba(3,24,18,.82);color:#c6ffe0;border-radius:12px;display:grid;place-items:center;box-shadow:0 2px 10px #0008;cursor:pointer}.pupage-arrow.left{left:1%}.pupage-arrow.right{right:1%}.pupage-arrow:disabled{opacity:.25;cursor:default}.pupage-filter{position:absolute;left:15%;right:15%;bottom:5%;display:flex;align-items:center;justify-content:center;gap:8px;color:#baffd1;font:700 11px/1.2 system-ui,sans-serif;text-shadow:0 1px 3px #000}.pupage-filter button{border:1px solid #70c493;border-radius:999px;background:#082219;color:#d6ffe8;padding:3px 8px;font:700 10px system-ui}.pupage-buy{display:block;margin:8px auto 0;border:1px solid #c9a33e;border-radius:999px;background:#112019;color:#ffe48a;padding:9px 16px;font-weight:700}.pupage-bottom-spacer{height:34px}
...
@media(max-width:430px){.pupage-head{min-height:138px;padding-left:55px;padding-right:55px}.pupage-logo{width:80vw}.pupage-corner{width:52px;height:52px}.pupage-enhance{width:94%}.pupage-stage{height:clamp(405px,116vw,500px)}.pupage-pet-zone{width:min(66vw,270px);height:min(66vw,270px)}.pupage-platform{width:82%;top:55%}.pupage-nameplate{width:98%}.pupage-capacity{padding:10px 12px}.pupage-stat-row{left:22%;right:6%;grid-template-columns:minmax(0,1fr) 43px 34px;gap:5px}.pupage-items-window{left:13%;right:13%}.pupage-arrow{width:34px;height:43px}}
`;
...
export default function PetPowerUpPage(props: PetUpgradeModalProps) {
  const { petName, petImage, petTemplateId, rarity, petLevel, petAtk, petDef, petHealth, itemsRemaining, items, isPending, subtitle, showBuyButton = false, successEffect, onUseItem, onSuccessAnimEnd, onClose } = props;
  ...
  return <div className="pupage" style={{ zIndex: z }} role="dialog" aria-modal="true" aria-label="Power Up">
    ...
    <div className="pupage-scroll">
      <header className="pupage-head">
        <button type="button" className="pupage-corner pupage-bag" onClick={() => openItems(null)} aria-label="Show all Power Up items"><img src={pupBagButton} alt="" /></button>
