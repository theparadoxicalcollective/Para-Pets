...
@media(max-width:430px){.pupage-head{min-height:100px;padding:0 46px}.pupage-logo{width:90vw}.pupage-corner{width:44px;height:44px}.pupage-capacity{width:94%;padding:7px 10px;margin-top:0}.pupage-enhance{width:78%}.pupage-stage{height:clamp(350px,102vw,430px);margin-top:-12px}.pupage-pet-zone{width:min(66vw,270px);height:min(66vw,270px);top:40%}.pupage-platform{width:82%;top:55%}.pupage-nameplate{width:98%}.pupage-stat-row{left:22%;right:6%;grid-template-columns:minmax(0,1fr) 43px 34px;gap:5px}.pupage-items-window{left:13%;right:13%}.pupage-arrow{width:34px;height:43px}}
`;
