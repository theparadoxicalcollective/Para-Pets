...
@media(max-width:430px){.pupage-head{min-height:96px;padding:0 46px}.pupage-logo{width:88vw}.pupage-corner{width:44px;height:44px}.pupage-capacity{width:90%;padding:5px 10px;margin-top:0}.pupage-enhance{width:70%}.pupage-stage{height:clamp(335px,92vw,395px);margin-top:-8px}.pupage-pet-zone{width:min(64vw,270px);height:min(64vw,270px);top:39%}.pupage-platform{width:80%;top:55%}.pupage-nameplate{width:86%}.pupage-inventory{margin-top:-30px}.pupage-stat-row{left:22%;right:6%;grid-template-columns:minmax(0,1fr) 43px 34px;gap:5px}.pupage-items-window{left:13%;right:13%}.pupage-arrow{width:34px;height:43px}.pupage-stats-close{width:38px;height:38px}}
`;
