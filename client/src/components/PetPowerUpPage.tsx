...
export default function PetPowerUpPage(props: PetUpgradeModalProps) {
  ...
  return <div className="pupage" style={{ zIndex: z }} role="dialog" aria-modal="true" aria-label="Power Up">
    ...
    <div className="pupage-scroll">
      ...
      <section className="pupage-enhance" aria-label={`${petName} has ${remaining} enhancements remaining`}><img src={pupEnhancementBar} alt="" className="pupage-enhance-art" /><div className="pupage-enhance-copy"><strong className="pupage-enhance-count">{remaining}</strong><span className="pupage-enhance-label">Enhancements Remain</span></div></section>
