  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          left: "50%",
          // Pulled the pet centerpiece up from 42% → 32% → 27% so the active
          // pet sits high in the frame, leaving the lower half free for the
          // status bars and inventory grid. The status-bar block follows
          // along (it anchors at calc(27% + 130px)).
          top: "27%",
          transform: "translate(-50%, -50%)",
          width: 300,
          height: 300,
