      ...
      <div className="relative flex flex-col h-full" style={{ paddingTop: "env(safe-area-inset-top, 0px)", visibility: isOverlayActive ? "hidden" : "visible" }}>
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-0 py-0 min-h-0">
          <div
            ...
            style={{ marginBottom: activePet ? "32svh" : undefined }}
          >
        ...
        {activePet && (
          <div className="relative z-10 flex-shrink-0 flex flex-col items-center gap-1 px-4" style={{ position: "fixed", bottom: "30vh", left: "50%", transform: "translateX(-50%)", zIndex: 20 }}>
            <div
