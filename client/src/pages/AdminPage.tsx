...
export default function AdminPage({ user }: AdminPageProps) {
  ...
  const sections = [
    ...
    { key: "items" as const, label: "Pets & Items", icon: adminIconPets, desc: "Item database", color: "#5eead4", glow: "rgba(94,234,212,0.30)", bg: "linear-gradient(145deg, rgba(8,45,42,0.92) 0%, rgba(14,70,65,0.88) 100%)", border: "rgba(94,234,212,0.45)" },
    { key: "pets" as const, label: "Animation Parts", icon: adminIconItems, desc: "Pet database", color: "#fdba74", glow: "rgba(251,146,60,0.30)", bg: "linear-gradient(145deg, rgba(72,32,8,0.92) 0%, rgba(110,52,12,0.88) 100%)", border: "rgba(251,146,60,0.45)" },
