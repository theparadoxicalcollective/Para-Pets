...
export const ELYSIAN_CLEARING_COMBAT_CONFIG = {
  ...
  // A slightly wider facing dead-zone prevents tiny steering corrections from
  // making sprites flip left/right while they are settling into an idle spot.
  facingDeadZonePixels: 6,
  ...
  // Passive enemies should drift rather than pace. Combat pursuit remains
  // intentionally faster so responsiveness is not lost when a fight begins.
  roamRadiusPixels: 76,
  roamSpeedPixels: 12,
  roamAccelerationPixels: 30,
  roamCurvePixels: 4,
  alertDurationMs: 420,
  pursuitSpeedPixels: 68,
  pursuitAccelerationPixels: 190,
  returnAccelerationPixels: 72,
